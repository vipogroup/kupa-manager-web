...
## L. Roadmap להמשך פיתוח

רשימת כל השלבים שעדיין **לא** בוצעו (משתמשים מרובים, Audit Log, Real-time, חיבור Windows/Web, מלאי מתקדם, ועוד) מתועדת במסמך:

- `docs/KUPA-MANAGER-WEB-FUTURE-ROADMAP.md`
- `docs/KUPA-MANAGER-WEB-FUTURE-ROADMAP.txt`

נקודת עצירה נוכחית: 8 משימות ה-Production הראשונות הושלמו.  
השלב הבא המומלץ: **MULTI-USER ROLES AND AUDIT LOG FOUNDATION** — רק לאחר אישור מפורש.
