...
export const MOBILE_REGISTRY: MobileRegistryElement[] = [
  ...
  el("orders", "details", "itemsSubtotal", "סכום מוצרים בפרטים"),
  el("orders", "details", "shippingFee", "מחיר משלוח בפרטים"),
  el("orders", "details", "totalAmount", "סה״כ הזמנה בפרטים", true),
  el("orders", "form", "productPickerName", "שם בבחירת מוצר", true),
  el("orders", "form", "productPickerModel", "דגם/מידה בבחירת מוצר", true),
  el("orders", "form", "itemModel", "דגם/מידה בשורת מוצר"),
  el("orders", "form", "itemsSubtotal", "סכום מוצרים בטופס"),
  el("orders", "form", "shippingFee", "מחיר משלוח בטופס", true),
  el("orders", "form", "totalAmount", "סה״כ הזמנה בטופס", true),
  el("orders", "summary", "shippingFee", "מחיר משלוח בסיכום"),
